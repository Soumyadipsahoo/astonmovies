    ...
    <section id="how-to" className="relative py-24 sm:py-32">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        >
          <a
            href="#download"
            className="inline-flex items-center gap-2 rounded-full bg-gradient-gold px-8 py-4 text-sm font-bold text-gold-foreground shadow-gold-strong transition-transform hover:scale-105"
          >
            Download App Now
          </a>
        </motion.div>
